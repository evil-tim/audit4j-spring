...
public abstract class SpringWebAuditMetadata implements MetaData {
    ...
    public String getOrigin() {
        try {
            return ((ServletRequest) ((ServletRequestAttributes) RequestContextHolder.currentRequestAttributes()).getRequest())
                .getRemoteAddr();
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     *
     * @param undefinedActorName the new undefined actor name
     */
     ...
     *
     * @param undefinedOriginName the new undefined origin name
     */
